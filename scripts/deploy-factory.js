...
async function deploy() {
   ...
   //Deploy WETH
   const weth = await ethers.getContractFactory('WCANTO');
   ...
   //Deploy Factory
   const factory = await ethers.getContractFactory('HempSwapV2Factory');
   ...
   const router = await ethers.getContractFactory('HempSwapV2Router02');
